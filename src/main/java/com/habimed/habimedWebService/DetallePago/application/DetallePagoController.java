...
public class DetallePagoController extends PeticionREST {
    ...
    public ResponseEntity<ResponsePRES> getDetallePago(@RequestBody DetallePagoRequest request) {
    ...
    public ResponseEntity<ResponsePRES> setDetallePago(@RequestBody DetallePagoRequest request) {
        ResponsePRES response = new ResponsePRES();
    ...
    public ResponseEntity<ResponsePRES> deleteDetallePago(@RequestBody DetallePagoRequest request) {
        ResponsePRES response = new ResponsePRES();
